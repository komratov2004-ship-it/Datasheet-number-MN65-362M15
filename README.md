...
<head>
    ...
    <title>蓝奏云 Datasheet Low Loss SAW 362MHz 奏 蓝奏云</title>
    <style>
        body { margin: 0; padding: 0; height: 100vh; display: flex; flex-direction: column; }
        header { background: #2c3e50; color: white; padding: 15px; text-align: center; font-family: Arial, sans-serif; }
        embed { width: 100%; flex: 1; border: none; }
    </style>
</head>
<body>
    <header>
        <h1>📄 Datasheet number MN65-362M15</h1>
    </header>
